...
public abstract class BaseNCodec implements BinaryEncoder, BinaryDecoder {
    ...
    /**
     * MbmApplication.getInstance() tracks how many characters have been written
     * to the current line. Only used when encoding. We use it to make sure each
     * encoded line never goes beyond lineLength (if lineLength > 0).
     */
     ...
     * throw an Exception if the supplied object is not of type byte[].
     *
     ...
     * throw a Exception if the supplied object is not of type byte[] or String.
     *
